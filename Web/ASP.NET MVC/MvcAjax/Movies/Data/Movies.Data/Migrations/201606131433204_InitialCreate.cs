namespace Movies.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            this.DropForeignKey("dbo.MovieActors", "Actor_Id", "dbo.Actors");
            this.DropForeignKey("dbo.MovieActors", "Movie_Id", "dbo.Movies");
            this.DropIndex("dbo.MovieActors", new[] { "Actor_Id" });
            this.DropIndex("dbo.MovieActors", new[] { "Movie_Id" });
            ...
            this.DropIndex("dbo.Actors", new[] { "IsDeleted" });
            this.DropTable("dbo.MovieActors");
